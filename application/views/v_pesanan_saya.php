                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                        ...
                        <table class="table">
                            ...
                            <?php foreach ($belum_bayar as $key => $value) {  ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($value->status_bayar == 0) { ?>
                                            <a href="<?= base_url('pesanan_saya/bayar/' . $value->id_transaksi) ?>" class="btn btn-xm btn-flat btn-primary"> Bayar </a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                        ...
                        <table class="table">
                            ...
                            <?php foreach ($di_proses as $key => $value) {  ?>
                                <tr>
                                    <td><?= $value->no_order ?></td>
                                    <td><?= $value->tanggal_order ?></td>
                                    <td>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                        ...
                        <table class="table">
                            ...
                            <?php foreach ($di_kirim as $key => $value) {  ?>
                                <tr>
                                    <td><?= $value->no_order ?></td>
                                    <td><?= $value->tanggal_order ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <h5><?= $value->no_resi ?></h5><br>
                                        <button data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" class="btn btn-xs btn-flat btn-primary">Diterima</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-settings" role="tabpanel" aria-labelledby="custom-tabs-four-settings-tab">
                        <!-- data pesanan di terima / selesai -->
                        <table class="table">
                            <tr>
                                <th>No Order</th>
                                <th>Tanggal Order</th>
