                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text text-center"><?= $value->nama_user ?></td>
                            <td class="text text-center"><?= $value->username ?></td>
                            <td class="text text-center"><?= $value->password ?></td>
                            <td class="text text-center"><?php
                                                            if ($value->level_user == 1) {
                                                                echo '<span class="badge bg-primary">Admin</span></td>';
                                                            } else {
                                                                echo '<span class="badge bg-success">User</span></td>';
                                                            }
                                                            ?>
                            </td>
