    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kategori" class="form-control">
                            ...
                            <?php foreach ($kategori as $key => $value) { ?>
                                <option value="<?= $value->id_kategori ?>"><?= $barang->nama_kategori ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="berat" min="0" class="form-control" placeholder="Berat Dalam Gr" value="<?= $barang->berat ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="5" placeholder="Deskripsi Barang" value=""><?= $barang->deskripsi ?></textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/' . $barang->gambar) ?>" id="gambar_load" width="369px">
                    </div>
                </div>
            </div>
